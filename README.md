...
* [`src/clj/challenge/`](src/clj/challenge/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/challenge/`](src/cljs/challenge/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/challenge/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `challenge` project root directory
...
in the [`src/clj/challenge/`](src/clj/challenge/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/challenge/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns challenge.example
